...
<div class="text-center project-referal">
	<p>This project is build on a custom made VueJS framework.</p>
	<a href="link" class="btn btn-primary" target="_blank">See project on Github</a>
</div>
...
<div class="row">
	...
	<div class="col-md-6">
		<ul class="no-bullets">
			...
			<li>
				<span class="ability-title">Turkish (Native tongue)</span>
				<span class="ability-score">
...
<div class="row">
	...
	<div class="col-md-6">
		<ul class="no-bullets">
			...
			<li>
				<span class="ability-title">FileZilla (4 years)</span>
				<span class="ability-score">
			...
			<li>
				<span class="ability-title">Notepad++ (6 years)</span>
				<span class="ability-score">
	...
	<div class="col-md-6">
		<ul class="no-bullets">
			...
			<li>
				<span class="ability-title">Sublime Text (4 years)</span>
				<span class="ability-score">
			...
			<li>
				<span class="ability-title">XAMPP (3 year)</span>
				<span class="ability-score">
			...
			<li>
				<span class="ability-title">PHPMyAdmin (3 years)</span>
				<span class="ability-score">
			...
			<li>
				<span class="ability-title">Adobe Photoshop (1 years)</span>
				<span class="ability-score">
